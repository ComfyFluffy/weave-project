...
export function CharacterStatusPanel({ character, state }: CharacterStatusPanelProps) {
      ...
      <VStack align="stretch" gap={3}>
        <HStack justify="space-between">
          <HStack gap={2}>
            ...
            {character.isNpc && (
              <Box bg="orange.500" color="white" px={1} py={0.5} borderRadius="sm" fontSize="xs">
                NPC
              </Box>
            )}
          </HStack>
          <Box bg={character.isNpc ? "orange.500" : "blue.500"} color="white" px={1} py={0.5} borderRadius="sm" fontSize="xs">
